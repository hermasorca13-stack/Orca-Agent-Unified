...
## 2026-08-03 ó Zero-Loss Audit (pre-laptop-transfer verification)
...
Em-dashes (ó) and smart quotes (\'\\) written to PowerShell
files got encoded as UTF-8 then re-read as Latin-1, producing
mojibake (\‚Ä"\). PowerShell 5.1 sees this as a multi-byte
...
## 2026-08-03 ‚Äî Canonical location: D:\ORCA AGENT (user mandate)
...
## 2026-08-03 ‚Äî Local-only project (GitHub repo removed)
