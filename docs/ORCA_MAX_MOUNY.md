...
| `docs/OPERATIONAL_AUDIT_2026-08-26.md` | التدقيق الهندسي والتشغيلي والأكاديمي ومطابقة runtime |
...
التقرير [`OPERATIONAL_AUDIT_2026-08-26.md`](OPERATIONAL_AUDIT_2026-08-26.md) يفرق بين الكود الموجود والتكامل المستدعى فعليًا والتحقق الخارجي. بعد التدقيق، تمر مسارات Paper الثلاثة عبر RiskEngine ثم Section20–24/23 قبل PaperExchange، وتحتاج `ExecutionPlan` إلى اعتماد صريح قبل adapter. Sandbox وLive والمضيف الدائم والمنصات الخارجية تظل غير متحققة دون الجهاز والحسابات والمصادر الخارجية اللازمة.
